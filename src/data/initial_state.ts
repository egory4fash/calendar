...
export const initialState: InitialStateType = {
    data: [
        ...
        },
        {
            ...
            month: '05',
            name: 'Дударскі рэй',
            description: '«Дударскі рэй» – международный фестиваль дударских регионов Беларуси и стран Западной Европы, который проходит в Глубокском районе 5 мая один раз в два года. В эти дни на улицах города можно услышать звуки дуды, а также увидеть красочное шествие участников фестиваля в национальных костюмах. Чарующие звуки дуды не оставят никого равнодушным и познакомят с фольклором разных народов.',
            town: 'Глубокский р-н'
        },
        {
            index: 5,
        ...
        },
        {
            ...
            description: 'Семейный молодёжный православный фестиваль ко Дню семьи, любви и верности “Под сенью Петра и Февроньи”.В агрогородке Сарья ежегодно отмечается День семьи, любви и верности. Праздник напоминает о главных жизненных ценностях, важности поддержки и заботы родных и близких людей. Приход Сарьянского Свято-Успенского храма встречает гостей на Богослужении, Крёстном ходе. У храма установлен памятник святым Петру и Февроньи, прикосновение к которому по поверьям приносит счастье и лад в семью. Общение с православными служителями церкви и душевной песней в этот день привлекает большое количество людей из разных городов Беларуси.',
